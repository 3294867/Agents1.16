...
const PausePlayButton = (props: Props) => {
  ...
  return (
    <button className='cursor-pointer flex justify-center items-center h-9 w-9 rounded-full border border-border bg-background hover:bg-black transition-colors duration-200'>
      {icon}
    </button>
  )
};
