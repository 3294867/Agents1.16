...
const updateThreadIsBookmarked = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { threadId, isBookmarked } = req.body;
    try {
    ...
    `;
        ...
        if (!result)
            return (0, sendResponse_1.sendResponse)(res, 503, "Failed to update 'isBookmarked' property");
...
exports.default = updateThreadIsBookmarked;
