...
const updateRequestBody = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { requestId, requestBody } = req.body;
    try {
    ...
    `;
        ...
        if (!result)
            return (0, sendResponse_1.sendResponse)(res, 503, "Failed to update request body");
...
exports.default = updateRequestBody;
